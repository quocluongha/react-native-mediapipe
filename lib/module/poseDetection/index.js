...
export function PoseDetectionOnImage(imagePath, model, options) {
  return getPoseDetectionModule().detectOnImage(imagePath, options?.numPoses ?? 1, options?.minPoseDetectionConfidence ?? 0.5, options?.minPosePresenceConfidence ?? 0.5, options?.minTrackingConfidence ?? 0.5, options?.shouldOutputSegmentationMasks ?? false, model, options?.delegate ?? Delegate.GPU);
}
...
export const KnownPoseLandmarkConnections = [[0, 5], [5, 8], [0, 2], [2, 7], [9, 10], [11, 12], [11, 13], [13, 15], [15, 17], [15, 19], [15, 21], [12, 14], [14, 16], [16, 18], [16, 20], [16, 22], [18, 20], [11, 23], [12, 24], [23, 24], [23, 25], [24, 26], [25, 27], [27, 29], [27, 31], [29, 31], [26, 28], [28, 30], [28, 32], [30, 32]];
